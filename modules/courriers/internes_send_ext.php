...
$req = "select * from courrier where expediteur like '%".$_POST['expediteur']."%' and destinataire like '%".$_POST['destinataire']."%' $type_courrier  $dated and categorie = 2 $orientation and orientation = '".$_SESSION['service']."' and tuteur != 100 order by id DESC";

}
else
{
$req = "SELECT * FROM courrier WHERE categorie='2' and orientation = '".$_SESSION['service']."' and tuteur != 100 ORDER BY id DESC LIMIT $PremiereAnnonceAafficher , $AnnoncesParPage ";
}
////echo $req;
