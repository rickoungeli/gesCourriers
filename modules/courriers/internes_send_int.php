<div class="titre2">Les courriers internes envoy&eacute;s</div>
...
$nbreannonce = $courrier->TotalMessageInternes($_SESSION['service']);
$AnnoncesParPage = 40;
...
echo '<center><span class="titre3">Page '.$page.' / '.$NbreDePages .' - '. $nbreannonce. '</span></center><br>';
}
else
{
...
$req = "select * from courrier where expediteur like '%".$_POST['expediteur']."%' and destinataire like '%".$_POST['destinataire']."%' $type_courrier  $dated and categorie = 2 order by id DESC";

}
else
{
$req = "SELECT * FROM courrier WHERE categorie='2' and tuteur != '100' and tuteur != 0 ORDER BY id DESC LIMIT $PremiereAnnonceAafficher , $AnnoncesParPage ";
}
////echo $req;
...
{
echo '<a class="message" href="index.php?module=courriers&action=internes&page=' . $i . '">' . $i . '</a> '; 
echo "&nbsp;&nbsp;&nbsp;";
}}
?>
  <p align="center">&nbsp;</p>
