<div class="titre2">Les courriers internes </div>
...
{
$req = "SELECT * FROM courrier WHERE categorie='2' and orientation = '".$_SESSION['service']."' ORDER BY id DESC LIMIT $PremiereAnnonceAafficher , $AnnoncesParPage ";
}
////echo $req;
