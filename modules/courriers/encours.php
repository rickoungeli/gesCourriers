<div class="titre2">Courrieres sortant</div>
...
*/
$nbreannonce = $courrier->TotalMessageLus($_SESSION['id_utilisateur']);
$AnnoncesParPage = 20;
...
$req = "SELECT * FROM courrier WHERE tuteur = '".$_SESSION['id_utilisateur']."' AND categorie='1' and (reception = 1 or lecture = '1') and traitement = '0' ORDER BY id DESC LIMIT $PremiereAnnonceAafficher , $AnnoncesParPage";
$courrier->affichersreq($req);
echo "<br>";
echo '<div align="center"><b>Page&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;   </b></span>';
for ($i = 1 ; $i <= $NbreDePages ; $i++)
{
echo '<a class="message" href="index.php?module=courriers&action=encours&page=' . $i . '">' . $i . '</a> '; 
echo "&nbsp;&nbsp;&nbsp;";
}
