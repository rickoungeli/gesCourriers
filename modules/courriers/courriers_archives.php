<div class="titre2">Les courriers trait&eacute;s et archiv&eacute;s</div>
...
$nbreannonce = $courrier->TotalArchive($_SESSION['service']);
$AnnoncesParPage = 40;
...
$req = "SELECT * FROM courrier WHERE traitement = '1' and (tuteur = '".$_SESSION['service']."' or orientation = '".$_SESSION['service']."')  and expediteur like '%".$_POST['expediteur']."%' and destinataire like '%".$_POST['destinataire']."%' and objet like '%".$_POST['objet']."%' $dated $type_courrier ORDER BY id DESC ";
}
else
{
$req = "SELECT * FROM courrier WHERE traitement = 1 and (tuteur = '".$_SESSION['service']."' or orientation = '".$_SESSION['service']."') ORDER BY id DESC LIMIT $PremiereAnnonceAafficher , $AnnoncesParPage ";
}
//echo $req;
...
{
echo '<a class="message" href="index.php?module=courriers&action=archives&page=' . $i . '">' . $i . '</a> '; 
echo "&nbsp;&nbsp;&nbsp;";
}}
?>
</form>
