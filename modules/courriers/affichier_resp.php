...
<div class="titre2">Nouveaux courriers du Responsable</div>
...
*/
$nbreannonce = $courrier->TotalMessageRecu($_SESSION['responsable']);
$AnnoncesParPage = 20;
...
$req = "SELECT * FROM courrier WHERE tuteur = '".$_SESSION['responsable']."'  AND categorie='1' and reception = 0 and lecture = '0' and traitement = '0' ORDER BY id DESC LIMIT $PremiereAnnonceAafficher , $AnnoncesParPage ";
$courrier->affichersreq($req);
echo "<br>";
echo '<div align="center"><b>Page&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;   </b></span>';
for ($i = 1 ; $i <= $NbreDePages ; $i++)
{
echo '<a class="message" href="index.php?module=resp&action=nonlus&page=' . $i . '">' . $i . '</a> '; 
echo "&nbsp;&nbsp;&nbsp;";
}
