...
<form name="form1" method="post" action="">
  <label>
  <span class="titre2">Synth&egrave;se actuelle du courrier</span><br>
  <textarea name="synthese" cols="40" rows="6" id="synthese"><?php echo $enregistrement['synthese']; ?></textarea>
  </label>
  <p>
    <label>
