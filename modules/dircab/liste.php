...
<br /><form id="form1" action="#" method="post">
  <table width="98%" border="0" align="center" cellpadding="4" cellspacing="0" style="border:solid 1px #0000FF;background:#F2F8FD">
    ...
    <tr>
      ...
      R&eacute;f.: <input name="ref" type="text" size="10" maxlength="20" class="inputbox" /></td>
...
<select name="anneed2" id="anneed2" class="inputbox" >
  ...
  <option>2030</option>
    ...
    <tr>
      ...
      <select name="pjourd" id="pjourd" class="inputbox">
        <option value="" selected="selected">Jour</option>
        <option>01</option>
        <option>02</option>
        <option>03</option>
...
/
<select name="pmoisd" id="pmoisd" class="inputbox" >
  <option selected="selected" value="">Mois</option>
  <option value="01">Janvier</option>
  <option value="02">F&eacute;vrier</option>
  <option value="03">Mars</option>
...
/
<label>
<select name="panneed" id="panneed" class="inputbox">
  <option selected="selected" value="">Ann&eacute;e</option>
  <option>2009</option>
  <option>2010</option>
  <option>2011</option>
...
<label style="color:#000000">Au</label>
      <select name="pjourd2" id="pjourd2" class="inputbox">
        <option value="" selected="selected">Jour</option>
        <option>01</option>
        <option>02</option>
        <option>03</option>
...
/
<select name="pmoisd2" id="pmoisd2" class="inputbox" >
  <option selected="selected" value="">Mois</option>
  <option value="01">Janvier</option>
  <option value="02">F&eacute;vrier</option>
  <option value="03">Mars</option>
...
/
<label>
<select name="panneed2" id="panneed2" class="inputbox">
  <option selected="selected" value="">Ann&eacute;e</option>
  <option>2009</option>
  <option>2010</option>
  <option>2011</option>
...
$nbreannonce = $courrier->TotalMessageNonOrientes();
$AnnoncesParPage = 40;
...
{
echo '<center><span class="titre3">R&eacute;sultats de la recherche</span> | <a href="index.php?module=dircab&action=entrant" class="message">Afficher Tout</a></center><br>';
}
...
if($_POST['pjourd'] != "" and $_POST['pmoisd'] != "" and $_POST['panneed'] != "" and $_POST['pjourd2'] != "" and $_POST['pmoisd2'] != "" and $_POST['panneed2'] != "") {
  $timestamp3 = mktime(0, 0, 0, $_POST['pmoisd'], $_POST['pjourd'], $_POST['panneed']);
  $timestamp4 = mktime(23, 59, 59, $_POST['pmoisd2'], $_POST['pjourd2'], $_POST['panneed2']);
  $dated = "and date_arrivee >= $timestamp3 and date_arrivee <= $timestamp4";
  }
...
$timestamp1 = mktime(0, 0, 0, $_POST['moisd'], $_POST['jourd'], $_POST['anneed']);
$timestamp2 = mktime(23, 59, 59, $_POST['moisd'], $_POST['jourd'] + 1, $_POST['anneed']);
...
$req = "select * from courrier where expediteur like '%".$_POST['expediteur']."%' and destinataire like '%".$_POST['destinataire']."%' $reception  $type_courrier  $dated $dated2 $orientation  $objet $ref and categorie = 1 order by id DESC "; 
}

else
{
$req = "SELECT * FROM courrier WHERE categorie='1' and reception >= 1 ORDER BY id DESC LIMIT $PremiereAnnonceAafficher , $AnnoncesParPage ";
}
//echo $req;
$courrier->afficheradmi($req);
echo "<br>";
...
for ($i = $debut ; $i <= $fin ; $i++)
{
echo '<a class="message" href="index.php?module=dircab&action=entrant&page=' . $i . '&groupe='.$groupe.'">' . $i . '</a> '; 
echo "&nbsp;&nbsp;&nbsp;";
}
$totalgroup = ceil($NbreDePages/20);
$group = $groupe + 1;
if($group <= $totalgroup ) {
echo '<a class="message" href="index.php?module=dircab&action=entrant&page=' . $i . '&groupe='.$group.'">Suivant&nbsp;&gt;&gt;&gt;</a>';
}}
?>
  <p align="center">Pour la s&eacute;lection  : 
   <label>
   &nbsp;&nbsp;
   <input type="submit" name="accuser" id="accuser" value="Accuser r&eacute;ception" />
</label>
    <label> &nbsp;&nbsp;</label>
     <label>
...
&nbsp;&nbsp;&nbsp;</label>
   <label><input type="submit" name="orienprov" id="orienprov" value="Orientation provisoire">
    </label>
    <label>
    &nbsp;&nbsp;<input type="submit" name="oriendef" id="oriendef" value="Orientation finale">
</label>
    <label> &nbsp;&nbsp;</label>
    <label>    </label>
    <label>    </label>
