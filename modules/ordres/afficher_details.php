...
<table width="95%" border="0" align="center" cellpadding="8" cellspacing="2">
  <tr>
    <td colspan="4" class="titre2">Ordre de mission n&deg;<?php echo $_GET['id_ordre']; ?></td>
  </tr>
  <tr>
  ...
  <tr>
    <td colspan="4"><div align="center">
        <label><a href="index.php?module=ordres&amp;action=gerer" class="message">R&eacute;tour &agrave; la liste des ordres</a></label>
    | 
    <label><a href="index.php?module=ordres&action=modifier&id_ordre=<?php echo $enreg['id_ordre']; ?>" class="message">Modifier cet ordre de mission</a></label>
</div></td>
  </tr>
</table>
<p>&nbsp;</p>
