...
{
$service = addslashes(htmlentities($_POST['libelle_service']));
include("connect.inc.php");
$req = "insert into services values('','$service','".$_POST['prefixe']."', '0')";
$res = mysql_query($req) or die ("Erreur SQL<br>".mysql_error());
echo "Service correctement ajout&eacute;, Merci <br>";
echo "<a href='javascript:history.back(-1)' class='message'>Retour</a><br><br>";
?>
<?php
}
?>