...
elseif($_POST['noms'] == "" or $_POST['objet'] == "" or $_POST['date_depart'] == "" or $_POST['date_arrivee'] == "" or $_POST['duree'] == "" or $_POST['qualite'] == "" ) {
...
$autorisation->moyens_transport =  addslashes($_POST['moyens_transport']);
...
$autorisation->modifier($_GET['id_autorisation']);
}
?>
</p>
<p align="center"><a href="index.php?module=autorisation&amp;action=gerer" class="message">R&eacute;tour &agrave; la liste des autorisations</a></p>
</body>
</html>
