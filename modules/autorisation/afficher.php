...
<p>
  ...
  <?php
require_once("classes/autorisation.class.inc.php");
$autorisation = new autorisation;
$nbreannonce = $autorisation->Totalautorisation();
$AnnoncesParPage = 40;
...
if(isset($_POST['noms'])) {
$req = "select * from autorisation where noms like '%".$_POST['noms']."%' and objet like '%".$_POST['objet']."%' and duree like '%".$_POST['duree']."%' order by id_autorisation desc";
}
else
{
$req = "select * from autorisation order by id_autorisation desc limit $PremiereAnnonceAafficher , $AnnoncesParPage";
}
$autorisation->afficher($req);
echo "<br>";
if(!isset($_POST['noms'])){
